...
const s = StyleSheet.create({
  ...
  noteCell: {
    flex: 1, padding: 3,
    borderRightWidth: 1, borderBottomWidth: 1, borderColor: BORDER,
    fontSize: 7, color: C.muted, fontStyle: "italic",
  },
  ...
  footer: {
    backgroundColor: M.primary, color: M.textOnPrimary, padding: 6,
    marginTop: 6, flexDirection: "row", alignItems: "center",
  },
  footerLeft: { flex: 2 },
  footerMain: { fontFamily: "Helvetica-Bold", fontSize: 8, color: M.textOnPrimary },
  footerSmall: { fontSize: 7, fontStyle: "italic", color: M.textOnPrimary, marginTop: 1 },
