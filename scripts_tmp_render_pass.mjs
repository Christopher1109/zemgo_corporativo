...
const doc = React.createElement(MedicalPassHIR, {
  snapshot: {
    ...
    incident_time: "14:30",
    incident_description: "El asegurado sufrió una caída en las escaleras del centro de trabajo, presentando lesión en tobillo derecho con inflamación y dolor moderado. Se solicita valoración médica y estudios de imagen.",
    hospital_name: "Hospital Ángeles del Pedregal",
  },
});
fs.writeFileSync("/tmp/pass.pdf", await renderToBuffer(doc));
